...
if __name__ == '__main__':
    ...
    parser.set_defaults(parallelize=False)

    # Qiskit parameters
    parser.add_argument("--backend_type", type=str, default="simulator",      choices=['simulator', 'IBMQ'])
    parser.add_argument("--backend_name", type=str, default="qasm_simulator", choices=['statevector_simulator', 'qasm_simulator'])
